...
$skillHighlights = [
    [
        'titleEn' => 'Expertise',
        'titleJa' => '技術領域と実務経験',
        'body'    => '実装から保守・運用まで継続的に携わってきた技術領域です。機能実装だけでなく、更新しやすさや運用のしやすさも意識した構成で開発に取り組んでいます。',
        'items'   => [
...
$projects = [
    [
        'title'    => '社内予約・受付管理システム（リニューアル）',
        'category' => 'Webアプリ',
        'stack'    => ['PHP', 'WordPress', 'JavaScript', 'MySQL'],
        'image'    => '',
        'details'  => [
            ['label' => '概要',         'value' => '社内で運用していた予約・受付管理システムのリニューアルを担当。旧システムの保守性の低さを改善し、管理画面の操作性向上と処理の安定性を目的にフルリビルドを行った。'],
            ['label' => '担当期間',     'value' => '2022年 〜 2023年（約1年）'],
            ['label' => '役割',         'value' => '開発メンバー（3名チーム）。フロントエンド実装・DB設計補佐・テストを担当。'],
            ['label' => '技術スタック詳細', 'value' => 'PHP / WordPress / JavaScript / MySQL / Docker'],
            ['label' => '担当内容',     'value' => '管理画面の UI 刷新（予約一覧・詳細・ステータス更新）、既存データの移行スクリプト作成、入力バリデーションの強化、単体・結合テストの実施。'],
            ['label' => '工夫した点',   'value' => '旧システムとの並行稼働期間中にデータ整合性を保つため、移行前後で件数・ステータスの照合チェックを自動化した。'],
            ['label' => '成果',         'value' => '管理担当者からの「操作が分かりやすくなった」というフィードバックを得た。処理エラーによる問い合わせも大幅に減少。'],
        ],
    ],
];
